...
par(mfrow=c(2,5))
plot_replicates_phylolm_trop_vs_temp_small(rates.df.merge=rates.df.merge.small)dev.off()
...
par(mfrow=(c(2,2)))
plot(abs(GBIFdata.BAMM.rates$Median.Latitude),GBIFdata.BAMM.rates$BAMM.fraction*100,pch=16,main='species',ylab='BAMM.sampling.fraction (%)',xlab='species median latitude',cex=.7,col="grey")
lm.lat.fraction.species<-lm(BAMM.fraction*100~abs(Median.Latitude),data=GBIFdata.BAMM.rates)
abline(lm.lat.fraction.species)
dev.off()
...
par(mfrow=(c(2,2)))
plot(GBIFdata.BAMM.rates$BAMM.fraction.percentage,log(GBIFdata.BAMM.rates$lambda.avg),pch=16,main='species',ylab='lambda (lineages/myr)',xlab='BAMM.sampling.fraction (%)',cex=.7,col='grey',yaxt='n')
...
lm.lambda.lat.fraction.species<-lm(log(lambda.avg)~abs(BAMM.fraction.percentage),data=GBIFdata.BAMM.rates)
abline(lm.lambda.lat.fraction.species,lty=2)
